                ...
                <div className="max-w-2xl mx-auto pt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <p className="text-slate-400">Pick one of your Spotify playlists and rank all its songs</p>
                        </button>
                        ...
                        >
                            ...
                            <p className="text-slate-400">Search for any album on Spotify and rank its tracks</p>
                        </button>
                    </div>
                </div>
            </div>
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-6">
                <div className="max-w-4xl mx-auto pt-8">
                    ...
                    <p className="text-slate-400 mb-6">Find any album on Spotify to rank</p>
